    ...
    <div id="toolbar">
       <form action="" id="fm" method="post" novalidate style="margin:0;padding:20px 50px">
            ...
            <div style="margin-bottom:10px">
                <input name="authorityName" class="easyui-textbox" required="true" label="权限:" style="width:100%">
            </div>
            <div style="margin-bottom:10px">
                <input name="authorityDesc" class="easyui-textbox" required="true" label="描述:" style="width:100%">
            </div>
